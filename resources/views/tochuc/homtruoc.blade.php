...
@section('orgmain')
    ...
    <div class="dashboard-container">
        ...
        <a href="{{ route('org.info_inday', ['ngayHienTai' => \Carbon\Carbon::parse($ngayHienTai)->toDateString()]) }}">
        ...
        <br><br>
        <form action="{{ route('org.homtruoc', ['ngayHienTai' => \Carbon\Carbon::parse($ngayHienTai)->toDateString()]) }}"
            method="GET">
