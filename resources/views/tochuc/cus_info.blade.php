...
@section('orgmain')
    ...
    <div class="dashboard-container">
        ...
        <br><br>
        <a href="{{ route('org.create_cus') }}"><button class="turn-back-button">THÊM MỚI<I></I></button></a>
        <br><br>
            ...
            @foreach ($client as $cus)
                <tr>
                    ...
                    <td style=" display: flexbox; justify-content: space-around ;">
                        <a href="{{ route('org.cus_detail', $cus->id) }}"><button class="view-btn">Chi tiết</button></a>
                        <a href="{{ route('org.update_cus', $cus->id) }}"><button class="update-btn">Sửa</button></a>
                    </td>
                </tr>
            @endforeach
        </table> <br><br>
