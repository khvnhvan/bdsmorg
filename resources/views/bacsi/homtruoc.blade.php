...
@section('docmain')
    ...
    <div class="dashboard-container">
        ...
        <br><br>
        <form action="{{ route('doc.homtruoc', ['ngayHienTai' => \Carbon\Carbon::parse($ngayHienTai)->toDateString()]) }}"
            method="GET">
                    ...
                    <tr>
                        ...
                        <td style=" display: flexbox; justify-content: space-around ;">
                            <a href="{{ route('doc.update_infoinday', $cl->id) }}"><button class="view-btn-2">Cập
                                    nhật</button></a>
                            <a href="{{ route('doc.check_clinic_homtruoc', $cl->user_id) }}"><button class="update-btn">Đơn
                                    khám</button></a>
                        </td>
                    </tr>
                @endforeach
