...
@section('empmain')
    ...
    <div class="dashboard-container">
        ...
        <br><br>
        <a href="{{ route('emp.homtruoc', ['ngayHienTai' => \Carbon\Carbon::parse($ngayHienTai)->toDateString()]) }}">
            Chuyển sang ngày hôm trước
        </a>
        <a href="{{ route('emp.info_inday', ['ngayHienTai' => \Carbon\Carbon::parse($ngayHienTai)->toDateString()]) }}">
            Chuyển sang ngày hôm nay
        </a>
        <a href="{{ route('emp.homsau', ['ngayHienTai' => \Carbon\Carbon::parse($ngayHienTai)->toDateString()]) }}">
        ...
        <br><br>
        <form action="{{ route('emp.homtruoc', ['ngayHienTai' => \Carbon\Carbon::parse($ngayHienTai)->toDateString()]) }}"
            method="GET">
        ...
        @else
            <p>Không có lịch sử hiến máu ngày hôm trước.</p>
        @endif
    @stop()
